...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <h4><asp:Label ID="titCantAnimales" runat="server" Text="Cantidad de elementos en la lista: " Visible="False"></asp:Label><asp:Label ID="lblCantAnimales" runat="server" ></asp:Label><h4><br/>
        </p>
    </div><br />
