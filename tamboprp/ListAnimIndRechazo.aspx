<%@ Page Title="tamboprp | con indicación de rechazo" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListAnimIndRechazo.aspx.cs" Inherits="tamboprp.ListAnimIndRechazo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-header">
        <h1><i class="menu-icon fa fa-shield"></i> Listado de Animales con indicación de rechazo </h1>
    </div>
    <div class="row">
        <div class="col-md-8">
        <asp:PlaceHolder ID="phPersonal" runat="server">
            <asp:GridView ID="gvAnimConIndRechazo" runat="server" AutoGenerateColumns="False" GridLines="None" HorizontalAlign="Left" 
                    ...
                    AllowPaging="true" AllowSorting="true" PageSize="20" OnPageIndexChanging="GvAnimConIndRechazo_PageIndexChanging" >
