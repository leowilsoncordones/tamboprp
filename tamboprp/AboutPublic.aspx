<%@ Page Title="tamboprp | acerca de" Language="C#" MasterPageFile="~/SitePublic.Master" AutoEventWireup="true" CodeBehind="AboutPublic.aspx.cs" Inherits="tamboprp.AboutPublic" %>
    ...
    <div class="row">
        <div class="col-md-8">
            <article>
                ...
                <p>
                    Gracias por visitar <small><span class="ace-icon fa fa-check-square-o" aria-hidden="true"></span></small><strong> tambo<span class="text-primary">prp</span></strong>,
                    y esperamos su <a runat="server" href="~/ContactPublic.aspx">Contacto</a> para comenzar su experiencia y 
                    formar parte de la aplicación referente de la industria lechera.<br/>
                </p>
            </article>
        </div>
