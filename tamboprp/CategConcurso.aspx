<%@ Page Title="tamboprp | categorias de concurso" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategConcurso.aspx.cs" Inherits="tamboprp.CategConcurso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-4">
            <div>
                <p>        
                <asp:GridView ID="gvCategConcurso" runat="server" AutoGenerateColumns="False" GridLines="None" HorizontalAlign="Left" 
                    ...
                    AllowPaging="true" AllowSorting="true" PageSize="20" OnPageIndexChanging="GvCategConcurso_PageIndexChanging" >
                <RowStyle HorizontalAlign="Left"  />
                <Columns>
                    <asp:BoundField DataField="Id_categ" HeaderText="Id" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField DataField="Nombre" HeaderText="Nombre de categoría" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />
                </Columns>
                <FooterStyle />
    ...
    <div id="newCategConc" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4><i class="ace-icon fa fa-save"></i> Ingreso categoría de concurso</h4>
                </div>
                    ...
                    <span id="bodySaveModal" class="text-warning center">
                        ...
                        <div id="formulario" class="form-horizontal">
                            ...
                            <div class="form-group">
			                    ...
			                    <div class="col-sm-6">
                                    <asp:TextBox ID="newCateg" CssClass="form-control col-xs-10 col-sm-5" runat="server"></asp:TextBox>
			                    </div>
		                    </div>
                        </div>
                    </span>
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button ID="btnSave" runat="server" CssClass="btn btn-sm btn-info" Text="Ok" OnClick="btn_GuardarCategConcurso" />
                </div>
            </div>
        </div>
    </div>
