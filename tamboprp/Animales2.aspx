<%@ Page Title="tamboprp | animales" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Animales2.aspx.cs" Inherits="tamboprp.Animales2" %>
...
<asp:Content ID="ContentAnimal" ContentPlaceHolderID="MainContent" runat="server">
    <h1 class="page-header">Ficha de animal</h1>
        <div class="row">
            <div class="col-md-4">        
