<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Indicadores.aspx.cs" Inherits="tamboprp.Indicadores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   <div class="page-header">
        <h1><i class="menu-icon fa fa-tachometer"></i> Indicadores <small><i class="ace-icon fa fa-angle-double-right"></i> resumen y estadísticas</small></h1>
    </div>
    <div class="row">
	    ...
	    <div class="infobox infobox-blue">
		    <div class="infobox-icon"><i class="ace-icon fa fa-twitter"></i></div>
            <div class="infobox-data">
