<%@ Page Title="tamboprp | diag. ecograficos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DiagEcograficos.aspx.cs" Inherits="tamboprp.DiagEcograficos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-header">
        <h1><i class="menu-icon fa fa-briefcase"></i> Diagnósticos ecográficos<small><i class="ace-icon fa fa-angle-double-right"></i> Vacas con mas de 35 días de servicio y aún sin diagnóstico</small></h1>
    </div> 
    <div class="row">
        <div class="col-md-12">
