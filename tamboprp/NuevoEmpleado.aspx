    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div id="formulario" class="form-horizontal">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> Iniciales en el sistema </label>
			        <div class="col-sm-3">
			            <input type="text" runat="server" id="fIniciales" class="form-control col-xs-10 col-sm-5" />
			        </div>
                    <div class="col-sm-12"></div>
		        </div>
                <!-- Botones -->
