...
namespace tamboprp
{
    public partial class AnalisisBajas : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            this.SetPageBreadcrumbs();
            this.LimpiarRegistro();
            this.CargarAnalisisBajas();
        }
        ...
        protected void SetPageBreadcrumbs()
        {
            ...
            list.Add(new VoListItemDuplaString("Análisis de bajas", ""));
        ...
        public void CargarAnalisisBajas()
        {
