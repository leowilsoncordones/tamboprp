...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        //    });
            ...
            var data = [
                { label: "terneras", data: 383, color: "#68BC31" },
                { label: "vaquillonas", data: 169, color: "#2091CF" },
                { label: "entoradas", data: 212, color: "#AF4E96" },
                { label: "en ordeñe", data: 661, color: "#DA5430" },
                { label: "secas", data: 137, color: "#FEE074" }
            ];
